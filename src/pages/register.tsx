          ...
          onSubmit={async (e) => {
            ...
            await client
              .post("users/survey", {
                ...
                json: {
                  awardsCount: Number(data.awardsCount),
                  certificationCount: Number(data.certificationCount),
                  clubActivityCount: Number(data.clubActivityCount),
                  englishScores: Number(data.englishScores),
